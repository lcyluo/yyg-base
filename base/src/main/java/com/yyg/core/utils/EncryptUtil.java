...
public final class EncryptUtil {
    ...
    public static String encryptMD5ToLowerCaseString(final String data) {
        return encryptMD5ToString(data).toLowerCase();
    }
    ...
    public static String encryptAES2Base64String(String data, String key) {
        return new String(encryptAES2Base64(data.getBytes(), key.getBytes(), "AES/ECB/PKCS5Padding", null));
    }
