...
public class BridgeUtil {
    final static String QZ_OVERRIDE_SCHEMA = "qz://";
    final static String QZ_RETURN_DATA = QZ_OVERRIDE_SCHEMA + "return/";//格式为   qz://return/{function}/returncontent
    final static String QZ_FETCH_QUEUE = QZ_RETURN_DATA + "_fetchQueue/";
    ...
    // 获取到传递信息的body值
    // url = qz://return/_fetchQueue/[{"responseId":"JAVA_CB_2_3957","responseData":"Javascript Says Right back aka!"}]
    public static String getDataFromReturnUrl(String url) {
        if (url.startsWith(QZ_FETCH_QUEUE)) {
            // return = [{"responseId":"JAVA_CB_2_3957","responseData":"Javascript Says Right back aka!"}]
            return url.replace(QZ_FETCH_QUEUE, EMPTY_STR);
        }

        // temp = _fetchQueue/[{"responseId":"JAVA_CB_2_3957","responseData":"Javascript Says Right back aka!"}]
        String temp = url.replace(QZ_RETURN_DATA, EMPTY_STR);
    ...
    // 获取到传递信息的方法
    // url = qz://return/_fetchQueue/[{"responseId":"JAVA_CB_1_360","responseData":"Javascript Says Right back aka!"}]
